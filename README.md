...
binocle/0.1.0 darwin-x64 node-v12.20.1
...
_See code: [src/commands/ls.ts](https://github.com/rthoyer/binocle/blob/v0.1.0/src/commands/ls.ts)_
...
_See code: [src/commands/restore.ts](https://github.com/rthoyer/binocle/blob/v0.1.0/src/commands/restore.ts)_
<!-- commandsstop -->
